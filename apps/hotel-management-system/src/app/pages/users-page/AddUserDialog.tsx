...
export const AddUserDialog = (props: AddUserDialogProps) => {
    ...
    useEffect(() => {
        if (firstName !== '' && lastName !== '' && username !== '' && password !== '' && selectedRoleId !== '') {
            setSaveButtonDisabled(false);
        } else {
            setSaveButtonDisabled(true);
        }
    }, [firstName, lastName, username, password, selectedRoleId])
            ...
            <DialogContent>
                <Stack gap={2}>
                    <Typography variant={"body1"}>
                        Enter user details below. The first name, last name, username, password and role fields are
                        required.
                    </Typography>
