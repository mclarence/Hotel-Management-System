export enum LogEventTypes {
    ...
    GUEST_SERVICE_ADD = 'GUEST_SERVICE_ADD',
    GUEST_SERVICE_UPDATE = 'GUEST_SERVICE_UPDATE',
    GUEST_SERVICE_DELETE = 'GUEST_SERVICE_DELETE',
    GUEST_SERVICE_ORDER_ADD = 'GUEST_SERVICE_ORDER_ADD',
    GUEST_SERVICE_ORDER_UPDATE = 'GUEST_SERVICE_ORDER_UPDATE',
    GUEST_SERVICE_ORDER_DELETE = 'GUEST_SERVICE_ORDER_DELETE',
}